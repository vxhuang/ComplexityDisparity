...
get_plotlist <- function(pol_df, pol_type) {
  ...
  final_scenario_list <- c('2017', 'Reference 2050', 'Net-Zero 2050', 'Net-Zero 2050 (ELE)', 'Net-Zero 2050 (Equity)',
                            'Net-Zero 2050 (SSP3)')
  ...
  if (pol_type == 'pm') {
    gg_race <- gg_race +
      ...
      annotate("text", x = 3, y = 1, label = as.character(sprintf('%.1f', round(filter(race_disp, scenario == 'Net-Zero 2050')$med_diff, 1))),
               col = 'Black', size = 3) +
      annotate("text", x = 4, y = 1, label = as.character(sprintf('%.1f', round(filter(race_disp, scenario == 'Net-Zero 2050 (ELE)')$med_diff, 1))),
               col = 'Black', size = 3) +
    ...
    gg_urban <- gg_urban +
      ...
      annotate("text", x = 3, y = 1, label = as.character(sprintf('%.1f', round(filter(urban_disp, scenario == 'Net-Zero 2050')$med_diff, 1))),
               col = 'Black', size = 3) +
      annotate("text", x = 4, y = 1, label = as.character(sprintf('%.1f', round(filter(urban_disp, scenario == 'Net-Zero 2050 (ELE)')$med_diff, 1))),
               col = 'Black', size = 3) +
    ...
    gg_income <- gg_income +
      ...
      annotate("text", x = 3, y = 1, label = as.character(sprintf('%.1f', round(filter(income_disp, scenario == 'Net-Zero 2050')$med_diff, 1))),
               col = 'Black', size = 3) +
      annotate("text", x = 4, y = 1, label = as.character(sprintf('%.1f', round(filter(income_disp, scenario == 'Net-Zero 2050 (ELE)')$med_diff, 1))),
               col = 'Black', size = 3) +
      ...
      annotate("text", x = 6, y = 1, label = as.character(sprintf('%.1f', round(filter(income_disp, scenario == 'Net-Zero 2050 (SSP3)')$med_diff, 1))),
               col = 'Black', size = 3) +
      theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
      ggtitle('e) Distribution of PM2.5 Across Income Groups')
  ...
  if (pol_type == 'ozone') {
    gg_race <- gg_race + 
      ...
      annotate("text", x = 3, y = 15, label = as.character(sprintf('%.1f', round(filter(race_disp, scenario == 'Net-Zero 2050')$med_diff, 1))),
               col = 'Black', size = 3) +
      annotate("text", x = 4, y = 15, label = as.character(sprintf('%.1f', round(filter(race_disp, scenario == 'Net-Zero 2050 (ELE)')$med_diff, 1))),
               col = 'Black', size = 3) +
      ...
      annotate("text", x = 6, y = 15, label = as.character(sprintf('%.1f', round(filter(race_disp, scenario == 'Net-Zero 2050 (SSP3)')$med_diff, 1))),
               col = 'Black', size = 3) +
      theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
      ggtitle('b) Distribution of Ozone Across Racial Groups')
    gg_urban <- gg_urban +
      ...
      annotate("text", x = 3, y = 15, label = as.character(sprintf('%.1f', round(filter(urban_disp, scenario == 'Net-Zero 2050')$med_diff, 1))),
               col = 'Black', size = 3) +
      annotate("text", x = 4, y = 15, label = as.character(sprintf('%.1f', round(filter(urban_disp, scenario == 'Net-Zero 2050 (ELE)')$med_diff, 1))),
               col = 'Black', size = 3) +
      ...
      annotate("text", x = 6, y = 15, label = as.character(sprintf('%.1f', round(filter(urban_disp, scenario == 'Net-Zero 2050 (SSP3)')$med_diff, 1))),
               col = 'Black', size = 3) +
      theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
      ggtitle('d) Distribution of Ozone Across Geography')
    gg_income <- gg_income +
      ...
      annotate("text", x = 3, y = 15, label = as.character(sprintf('%.1f', round(filter(income_disp, scenario == 'Net-Zero 2050')$med_diff, 1))),
               col = 'Black', size = 3) +
      annotate("text", x = 4, y = 15, label = as.character(sprintf('%.1f', round(filter(income_disp, scenario == 'Net-Zero 2050 (ELE)')$med_diff, 1))),
               col = 'Black', size = 3) +
      ...
      annotate("text", x = 6, y = 15, label = as.character(sprintf('%.1f', round(filter(income_disp, scenario == 'Net-Zero 2050 (SSP3)')$med_diff, 1))),
               col = 'Black', size = 3) +
      theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
      ggtitle('f) Distribution of Ozone Across Income Groups')
  }
...
jpeg(paste0(plot_dir, '/fig3_', Sys.Date(), '.jpg'), 
     width = 9, height = 12, quality = 1, units = 'in', res = 300)
print(ggarrange(plotlist = all_plots[c(1, 4, 3, 6, 2, 5)], nrow = 3, ncol = 2))
dev.off()

pdf(paste0(plot_dir, '/fig3_', Sys.Date(), '.pdf'), width = 9, height = 12)
print(ggarrange(plotlist = all_plots[c(1, 4, 3, 6, 2, 5)], nrow = 3, ncol = 2))
dev.off()

svg(paste0(plot_dir, '/fig3_', Sys.Date(), '.svg'), width = 9, height = 12)
print(ggarrange(plotlist = all_plots[c(1, 4, 3, 6, 2, 5)], nrow = 3, ncol = 2))
dev.off()
